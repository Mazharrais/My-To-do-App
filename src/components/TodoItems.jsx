    ...
    return (
        ...
        `}>{todo.text}</span>
            ...
            <div className="flex space-x-3 ml-8">
                ...
                <button onClick={() => dispatch(removeTodo(index))} className="mr-2 text-sm bg-red-500 text-white sm:px-2 py-1 rounded">
                    <FaTrash />
                </button>

                {!todo.completed && (
                    <button className="mr-2 text-sm bg-yellow-500 text-white sm:px-2 py-1 px-1 rounded"
                ...
                {todo.completed && (
                    <button className="mr-2 text-sm bg-green-500 text-white sm:px-2 py-1 px-1 rounded"
